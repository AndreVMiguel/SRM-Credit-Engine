  ...
  return <section className="workspace-grid">
    <div className="card form-card">
      ...
      <div className="form-grid">
        ...
        <label className="field"><span>Moeda do ativo</span><select value={form.assetCurrency} onChange={e=>update('assetCurrency',e.target.value)}><option value="BRL">Real brasileiro (BRL)</option><option value="USD">Dólar americano (USD)</option></select></label>
        <label className="field"><span>Moeda de liquidação</span><select value={form.settlementCurrency} onChange={e=>update('settlementCurrency',e.target.value)}><option value="BRL">Real brasileiro (BRL)</option><option value="USD">Dólar americano (USD)</option></select></label>
